...
<div class="title"> 
    <h1>Procesadores</h1>
    <p>Encuentre procesadores al mejor precio.</p>
</div>
                ...
                <tr>
                    <td>
                        <div class="table-content">
                            ...
                            <div class="text semi-bold-text"><?php echo $row[1]." ".$row[2]." ".$row[3]." ".$row[4];?></div>
                        </div>
                    </td>
                    <td>
                        <div class="table-content">
                    ...
                    <td>
                        <div class="table-content last-item">
                            <div class="text semi-bold-text"><?php echo "S/. ".$row[10];?></div>
                            <button type="button" title="Agregar al carrito" onclick="cartAction('add', '<?php echo $row[11];?>', 'products')" >
